                    ...
                    <div class="review-tab-pro-inner">
                        <div id="edit">
                            <ul id="myTab3" class="tab-review-design">
                                <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Pemesanan Baju</a></li>
                            </ul>
                        </div>
                                        ...
                                        <div class="col-lg-10 col-md-6 col-sm-6 col-xs-12">
                                            <div class="review-content-section" id="tengah">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <input type="text" class="form-control input-disabled" disabled name="ukuran" value="<?php if ($pilih_k == "1") {
                                                                                                                                                echo "S";
                                                                                                                                            } else if ($pilih_k == "2") {
                                                                                                                                                echo "M";
                                                                                                                                            } else if ($pilih_k == "3") {
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                    <input type="text" class="form-control input-disabled" placeholder="Masukkan Banyak Stok Yang di beli " name="stok-berkurang" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="text-center custom-pro-edt-ds">
                                                <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10" name="pesan">Pesan
                                                </button>
