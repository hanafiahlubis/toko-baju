    ...
    <div class="row">
      ...
      <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
        <div class="text-center custom-login">
          <h3 class="judul">Registration</h3>
          <p class="judul">Admin template with very clean and aesthetic style prepared for your next app. </p>
        </div>
        <div class="hpanel">
          <div class="panel-body">
            <form action="proses.php" method="POST" id="loginForm">
              ...
              <div class="text-center">
                ...
                <button class="btn btn-default" href="login.php">Cancel</button>
              </div>
            </form>
          </div>
        </div>
